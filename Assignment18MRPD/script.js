...
async function loadPage() {
    let previousData;
    await axios.get("https://crudcrud.com/api/17f6a2a9831a452a843ddbc8c0431388/appointmentData")
...
function checkItem(e) {
    ...
    if(e.target.classList.contains('deleteClass')){
        ...
        let key = li.id; //id is stored as id of each list element
